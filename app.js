...
const userRouter = require("./API/routes/usersRoute");
...
const viewRouter = require("./API/routes/viewsRouter");
...
app.use(express.static(path.join(__dirname, "GlobalComponents")));
